...
class ResNet:
    ...
    def get_resnet_tictactoe_6x6(self):
        """
        Method for returning model for tictactoe on 6 by 6 board
        :return: ResNet model for tictactoe on 6 by 6 board.
        """
        return self.build(height=6,
                          width=6,
                          depth=2,
                          filters=256,
                          policy_output_dim=36)