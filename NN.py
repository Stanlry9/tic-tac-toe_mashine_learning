...
class TicTacNet(nn.Module):
    def __init__(self):
        super().__init__()
        self.dl1 = nn.Linear(INPUT_SIZE, INPUT_SIZE*8)
        self.dl2 = nn.Linear(INPUT_SIZE*8, OUTPUT_SIZE*8)
        self.dl3 = nn.Linear(INPUT_SIZE*8, OUTPUT_SIZE*8)
        self.output_layer = nn.Linear(OUTPUT_SIZE*8, OUTPUT_SIZE)
